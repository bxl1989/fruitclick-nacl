; ModuleID = 'Dynamics/Contacts/b2CircleContact.cpp'
target datalayout = "e-p:32:32:32-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:32:64-f32:32:32-f64:32:64-v64:64:64-v128:128:128-a0:0:64-f80:32:32-n8:16:32-S128"
target triple = "i386-pc-linux-gnu"

%class.b2CircleContact = type { %class.b2Contact }
...
@_ZTI15b2CircleContact = unnamed_addr constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i32 2) to i8*), i8* getelementptr inbounds ([18 x i8]* @_ZTS15b2CircleContact, i32 0, i32 0), i8* bitcast ({ i8*, i8* }* @_ZTI9b2Contact to i8*) }

@_ZN15b2CircleContactC1EP9b2FixtureS1_ = alias void (%class.b2CircleContact*, %class.b2Fixture*, %class.b2Fixture*)* @_ZN15b2CircleContactC2EP9b2FixtureS1_

define %class.b2Contact* @_ZN15b2CircleContact6CreateEP9b2FixtureiS1_iP16b2BlockAllocator(%class.b2Fixture* %fixtureA, i32, %class.b2Fixture* %fixtureB, i32, %class.b2BlockAllocator* %allocator) align 2 {
...
; <label>:12                                      ; preds = %2
  %13 = bitcast i8* %10 to %class.b2CircleContact*
  %14 = load %class.b2Fixture** %3, align 4
  %15 = load %class.b2Fixture** %5, align 4
  call void @_ZN15b2CircleContactC1EP9b2FixtureS1_(%class.b2CircleContact* %13, %class.b2Fixture* %14, %class.b2Fixture* %15)
  br label %16

; <label>:16                                      ; preds = %12, %2
  %17 = phi %class.b2CircleContact* [ %13, %12 ], [ null, %2 ]
  %18 = bitcast %class.b2CircleContact* %17 to %class.b2Contact*
  ret %class.b2Contact* %18
}

declare i8* @_ZN16b2BlockAllocator8AllocateEi(%class.b2BlockAllocator*, i32)

define void @_ZN15b2CircleContact7DestroyEP9b2ContactP16b2BlockAllocator(%class.b2Contact* %contact, %class.b2BlockAllocator* %allocator) align 2 {
  ...
  %6 = load void (%class.b2CircleContact*)*** %5
  %7 = getelementptr inbounds void (%class.b2CircleContact*)** %6, i64 1
  %8 = load void (%class.b2CircleContact*)** %7
...
define void @_ZN15b2CircleContactC2EP9b2FixtureS1_(%class.b2CircleContact* %this, %class.b2Fixture* %fixtureA, %class.b2Fixture* %fixtureB) unnamed_addr align 2 {
  %1 = alloca %class.b2CircleContact*, align 4
  %2 = alloca %class.b2Fixture*, align 4
  %3 = alloca %class.b2Fixture*, align 4
  %4 = alloca i8*
  %5 = alloca i32
  store %class.b2CircleContact* %this, %class.b2CircleContact** %1, align 4
  store %class.b2Fixture* %fixtureA, %class.b2Fixture** %2, align 4
  store %class.b2Fixture* %fixtureB, %class.b2Fixture** %3, align 4
  %6 = load %class.b2CircleContact** %1
  ...
  %10 = bitcast %class.b2CircleContact* %6 to i8***
  store i8** getelementptr inbounds ([5 x i8*]* @_ZTV15b2CircleContact, i64 0, i64 2), i8*** %10
...
; <label>:18                                      ; preds = %15
  call void @__assert_fail(i8* getelementptr inbounds ([43 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([38 x i8]* @.str1, i32 0, i32 0), i32 44, i8* getelementptr inbounds ([59 x i8]* @__PRETTY_FUNCTION__._ZN15b2CircleContactC2EP9b2FixtureS1_, i32 0, i32 0)) noreturn nounwind
  unreachable
...
; <label>:33                                      ; preds = %30
  call void @__assert_fail(i8* getelementptr inbounds ([43 x i8]* @.str2, i32 0, i32 0), i8* getelementptr inbounds ([38 x i8]* @.str1, i32 0, i32 0), i32 45, i8* getelementptr inbounds ([59 x i8]* @__PRETTY_FUNCTION__._ZN15b2CircleContactC2EP9b2FixtureS1_, i32 0, i32 0)) noreturn nounwind
  unreachable
                                                  ; No predecessors!
  br label %35
...
define void @_ZN15b2CircleContact8EvaluateEP10b2ManifoldRK11b2TransformS4_(%class.b2CircleContact* %this, %struct.b2Manifold* %manifold, %struct.b2Transform* %xfA, %struct.b2Transform* %xfB) align 2 {
  %1 = alloca %class.b2CircleContact*, align 4
  ...
  %5 = load %class.b2CircleContact** %1
  ...
  call void @_Z16b2CollideCirclesP10b2ManifoldPK13b2CircleShapeRK11b2TransformS3_S6_(%struct.b2Manifold* %6, %class.b2CircleShape* %11, %struct.b2Transform* %12, %class.b2CircleShape* %17, %struct.b2Transform* %18)
  ret void
}

declare void @_Z16b2CollideCirclesP10b2ManifoldPK13b2CircleShapeRK11b2TransformS3_S6_(%struct.b2Manifold*, %class.b2CircleShape*, %struct.b2Transform*, %class.b2CircleShape*, %struct.b2Transform*)
...
define linkonce_odr void @_ZN15b2CircleContactD1Ev(%class.b2CircleContact* %this) unnamed_addr align 2 {
  %1 = alloca %class.b2CircleContact*, align 4
  store %class.b2CircleContact* %this, %class.b2CircleContact** %1, align 4
  %2 = load %class.b2CircleContact** %1
  call void @_ZN15b2CircleContactD2Ev(%class.b2CircleContact* %2)
  ret void
}

define linkonce_odr void @_ZN15b2CircleContactD0Ev(%class.b2CircleContact* %this) unnamed_addr align 2 {
  %1 = alloca %class.b2CircleContact*, align 4
  %2 = alloca i8*
  %3 = alloca i32
  store %class.b2CircleContact* %this, %class.b2CircleContact** %1, align 4
  %4 = load %class.b2CircleContact** %1
  invoke void @_ZN15b2CircleContactD1Ev(%class.b2CircleContact* %4)
...
define linkonce_odr void @_ZN15b2CircleContactD2Ev(%class.b2CircleContact* %this) unnamed_addr align 2 {
  %1 = alloca %class.b2CircleContact*, align 4
  store %class.b2CircleContact* %this, %class.b2CircleContact** %1, align 4
  %2 = load %class.b2CircleContact** %1
