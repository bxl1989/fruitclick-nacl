; ModuleID = 'Dynamics/Contacts/b2ChainAndPolygonContact.cpp'
target datalayout = "e-p:32:32:32-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:32:64-f32:32:32-f64:32:64-v64:64:64-v128:128:128-a0:0:64-f80:32:32-n8:16:32-S128"
target triple = "i386-pc-linux-gnu"

%class.b2ChainAndPolygonContact = type { %class.b2Contact }
...
@_ZTI24b2ChainAndPolygonContact = unnamed_addr constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i32 2) to i8*), i8* getelementptr inbounds ([27 x i8]* @_ZTS24b2ChainAndPolygonContact, i32 0, i32 0), i8* bitcast ({ i8*, i8* }* @_ZTI9b2Contact to i8*) }
...
@_ZN24b2ChainAndPolygonContactC1EP9b2FixtureiS1_i = alias void (%class.b2ChainAndPolygonContact*, %class.b2Fixture*, i32, %class.b2Fixture*, i32)* @_ZN24b2ChainAndPolygonContactC2EP9b2FixtureiS1_i

define %class.b2Contact* @_ZN24b2ChainAndPolygonContact6CreateEP9b2FixtureiS1_iP16b2BlockAllocator(%class.b2Fixture* %fixtureA, i32 %indexA, %class.b2Fixture* %fixtureB, i32 %indexB, %class.b2BlockAllocator* %allocator) align 2 {
...
; <label>:10                                      ; preds = %0
  %11 = bitcast i8* %8 to %class.b2ChainAndPolygonContact*
  %12 = load %class.b2Fixture** %1, align 4
  %13 = load i32* %2, align 4
  %14 = load %class.b2Fixture** %3, align 4
  %15 = load i32* %4, align 4
  call void @_ZN24b2ChainAndPolygonContactC1EP9b2FixtureiS1_i(%class.b2ChainAndPolygonContact* %11, %class.b2Fixture* %12, i32 %13, %class.b2Fixture* %14, i32 %15)
  br label %16

; <label>:16                                      ; preds = %10, %0
  %17 = phi %class.b2ChainAndPolygonContact* [ %11, %10 ], [ null, %0 ]
  %18 = bitcast %class.b2ChainAndPolygonContact* %17 to %class.b2Contact*
  ret %class.b2Contact* %18
}

declare i8* @_ZN16b2BlockAllocator8AllocateEi(%class.b2BlockAllocator*, i32)

define void @_ZN24b2ChainAndPolygonContact7DestroyEP9b2ContactP16b2BlockAllocator(%class.b2Contact* %contact, %class.b2BlockAllocator* %allocator) align 2 {
  ...
  %6 = load void (%class.b2ChainAndPolygonContact*)*** %5
  %7 = getelementptr inbounds void (%class.b2ChainAndPolygonContact*)** %6, i64 1
  %8 = load void (%class.b2ChainAndPolygonContact*)** %7
...
define void @_ZN24b2ChainAndPolygonContactC2EP9b2FixtureiS1_i(%class.b2ChainAndPolygonContact* %this, %class.b2Fixture* %fixtureA, i32 %indexA, %class.b2Fixture* %fixtureB, i32 %indexB) unnamed_addr align 2 {
  %1 = alloca %class.b2ChainAndPolygonContact*, align 4
  ...
  %6 = alloca i8*
  %7 = alloca i32
  store %class.b2ChainAndPolygonContact* %this, %class.b2ChainAndPolygonContact** %1, align 4
  ...
  %8 = load %class.b2ChainAndPolygonContact** %1
  ...
  %14 = bitcast %class.b2ChainAndPolygonContact* %8 to i8***
  store i8** getelementptr inbounds ([5 x i8*]* @_ZTV24b2ChainAndPolygonContact, i64 0, i64 2), i8*** %14
...
; <label>:22                                      ; preds = %19
  call void @__assert_fail(i8* getelementptr inbounds ([42 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([47 x i8]* @.str1, i32 0, i32 0), i32 43, i8* getelementptr inbounds ([91 x i8]* @__PRETTY_FUNCTION__._ZN24b2ChainAndPolygonContactC2EP9b2FixtureiS1_i, i32 0, i32 0)) noreturn nounwind
  unreachable
...
; <label>:37                                      ; preds = %34
  call void @__assert_fail(i8* getelementptr inbounds ([44 x i8]* @.str2, i32 0, i32 0), i8* getelementptr inbounds ([47 x i8]* @.str1, i32 0, i32 0), i32 44, i8* getelementptr inbounds ([91 x i8]* @__PRETTY_FUNCTION__._ZN24b2ChainAndPolygonContactC2EP9b2FixtureiS1_i, i32 0, i32 0)) noreturn nounwind
  unreachable
                                                  ; No predecessors!
  br label %39
...
define void @_ZN24b2ChainAndPolygonContact8EvaluateEP10b2ManifoldRK11b2TransformS4_(%class.b2ChainAndPolygonContact* %this, %struct.b2Manifold* %manifold, %struct.b2Transform* %xfA, %struct.b2Transform* %xfB) align 2 {
  %1 = alloca %class.b2ChainAndPolygonContact*, align 4
  ...
  %7 = load %class.b2ChainAndPolygonContact** %1
...
; <label>:24                                      ; preds = %17
  ...
  invoke void @_Z23b2CollideEdgeAndPolygonP10b2ManifoldPK11b2EdgeShapeRK11b2TransformPK14b2PolygonShapeS6_(%struct.b2Manifold* %18, %class.b2EdgeShape* %edge, %struct.b2Transform* %19, %class.b2PolygonShape* %25, %struct.b2Transform* %26)
...
define linkonce_odr void @_ZN24b2ChainAndPolygonContactD1Ev(%class.b2ChainAndPolygonContact* %this) unnamed_addr align 2 {
  %1 = alloca %class.b2ChainAndPolygonContact*, align 4
  store %class.b2ChainAndPolygonContact* %this, %class.b2ChainAndPolygonContact** %1, align 4
  %2 = load %class.b2ChainAndPolygonContact** %1
  call void @_ZN24b2ChainAndPolygonContactD2Ev(%class.b2ChainAndPolygonContact* %2)
  ret void
}

define linkonce_odr void @_ZN24b2ChainAndPolygonContactD0Ev(%class.b2ChainAndPolygonContact* %this) unnamed_addr align 2 {
  %1 = alloca %class.b2ChainAndPolygonContact*, align 4
  %2 = alloca i8*
  %3 = alloca i32
  store %class.b2ChainAndPolygonContact* %this, %class.b2ChainAndPolygonContact** %1, align 4
  %4 = load %class.b2ChainAndPolygonContact** %1
  invoke void @_ZN24b2ChainAndPolygonContactD1Ev(%class.b2ChainAndPolygonContact* %4)
...
define linkonce_odr void @_ZN24b2ChainAndPolygonContactD2Ev(%class.b2ChainAndPolygonContact* %this) unnamed_addr align 2 {
  %1 = alloca %class.b2ChainAndPolygonContact*, align 4
  store %class.b2ChainAndPolygonContact* %this, %class.b2ChainAndPolygonContact** %1, align 4
  %2 = load %class.b2ChainAndPolygonContact** %1
