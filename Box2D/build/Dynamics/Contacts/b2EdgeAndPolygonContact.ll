; ModuleID = 'Dynamics/Contacts/b2EdgeAndPolygonContact.cpp'
target datalayout = "e-p:32:32:32-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:32:64-f32:32:32-f64:32:64-v64:64:64-v128:128:128-a0:0:64-f80:32:32-n8:16:32-S128"
target triple = "i386-pc-linux-gnu"

%class.b2EdgeAndPolygonContact = type { %class.b2Contact }
...
@_ZTV23b2EdgeAndPolygonContact = unnamed_addr constant [5 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTI23b2EdgeAndPolygonContact to i8*), i8* bitcast (void (%class.b2EdgeAndPolygonContact*, %struct.b2Manifold*, %struct.b2Transform*, %struct.b2Transform*)* @_ZN23b2EdgeAndPolygonContact8EvaluateEP10b2ManifoldRK11b2TransformS4_ to i8*), i8* bitcast (void (%class.b2EdgeAndPolygonContact*)* @_ZN23b2EdgeAndPolygonContactD1Ev to i8*), i8* bitcast (void (%class.b2EdgeAndPolygonContact*)* @_ZN23b2EdgeAndPolygonContactD0Ev to i8*)]
@.str = private unnamed_addr constant [41 x i8] c"m_fixtureA->GetType() == b2Shape::e_edge\00", align 1
@.str1 = private unnamed_addr constant [46 x i8] c"Dynamics/Contacts/b2EdgeAndPolygonContact.cpp\00", align 1
...
@.str2 = private unnamed_addr constant [44 x i8] c"m_fixtureB->GetType() == b2Shape::e_polygon\00", align 1
...
@_ZTI23b2EdgeAndPolygonContact = unnamed_addr constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i32 2) to i8*), i8* getelementptr inbounds ([26 x i8]* @_ZTS23b2EdgeAndPolygonContact, i32 0, i32 0), i8* bitcast ({ i8*, i8* }* @_ZTI9b2Contact to i8*) }

@_ZN23b2EdgeAndPolygonContactC1EP9b2FixtureS1_ = alias void (%class.b2EdgeAndPolygonContact*, %class.b2Fixture*, %class.b2Fixture*)* @_ZN23b2EdgeAndPolygonContactC2EP9b2FixtureS1_

define %class.b2Contact* @_ZN23b2EdgeAndPolygonContact6CreateEP9b2FixtureiS1_iP16b2BlockAllocator(%class.b2Fixture* %fixtureA, i32, %class.b2Fixture* %fixtureB, i32, %class.b2BlockAllocator* %allocator) align 2 {
...
; <label>:12                                      ; preds = %2
  %13 = bitcast i8* %10 to %class.b2EdgeAndPolygonContact*
  %14 = load %class.b2Fixture** %3, align 4
  %15 = load %class.b2Fixture** %5, align 4
  call void @_ZN23b2EdgeAndPolygonContactC1EP9b2FixtureS1_(%class.b2EdgeAndPolygonContact* %13, %class.b2Fixture* %14, %class.b2Fixture* %15)
  br label %16

; <label>:16                                      ; preds = %12, %2
  %17 = phi %class.b2EdgeAndPolygonContact* [ %13, %12 ], [ null, %2 ]
  %18 = bitcast %class.b2EdgeAndPolygonContact* %17 to %class.b2Contact*
  ret %class.b2Contact* %18
}

declare i8* @_ZN16b2BlockAllocator8AllocateEi(%class.b2BlockAllocator*, i32)

define void @_ZN23b2EdgeAndPolygonContact7DestroyEP9b2ContactP16b2BlockAllocator(%class.b2Contact* %contact, %class.b2BlockAllocator* %allocator) align 2 {
  ...
  %6 = load void (%class.b2EdgeAndPolygonContact*)*** %5
  %7 = getelementptr inbounds void (%class.b2EdgeAndPolygonContact*)** %6, i64 1
  %8 = load void (%class.b2EdgeAndPolygonContact*)** %7
...
define void @_ZN23b2EdgeAndPolygonContactC2EP9b2FixtureS1_(%class.b2EdgeAndPolygonContact* %this, %class.b2Fixture* %fixtureA, %class.b2Fixture* %fixtureB) unnamed_addr align 2 {
  %1 = alloca %class.b2EdgeAndPolygonContact*, align 4
  %2 = alloca %class.b2Fixture*, align 4
  %3 = alloca %class.b2Fixture*, align 4
  %4 = alloca i8*
  %5 = alloca i32
  store %class.b2EdgeAndPolygonContact* %this, %class.b2EdgeAndPolygonContact** %1, align 4
  store %class.b2Fixture* %fixtureA, %class.b2Fixture** %2, align 4
  store %class.b2Fixture* %fixtureB, %class.b2Fixture** %3, align 4
  %6 = load %class.b2EdgeAndPolygonContact** %1
  ...
  %10 = bitcast %class.b2EdgeAndPolygonContact* %6 to i8***
  store i8** getelementptr inbounds ([5 x i8*]* @_ZTV23b2EdgeAndPolygonContact, i64 0, i64 2), i8*** %10
...
; <label>:18                                      ; preds = %15
  call void @__assert_fail(i8* getelementptr inbounds ([41 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([46 x i8]* @.str1, i32 0, i32 0), i32 41, i8* getelementptr inbounds ([75 x i8]* @__PRETTY_FUNCTION__._ZN23b2EdgeAndPolygonContactC2EP9b2FixtureS1_, i32 0, i32 0)) noreturn nounwind
  unreachable
...
; <label>:33                                      ; preds = %30
  call void @__assert_fail(i8* getelementptr inbounds ([44 x i8]* @.str2, i32 0, i32 0), i8* getelementptr inbounds ([46 x i8]* @.str1, i32 0, i32 0), i32 42, i8* getelementptr inbounds ([75 x i8]* @__PRETTY_FUNCTION__._ZN23b2EdgeAndPolygonContactC2EP9b2FixtureS1_, i32 0, i32 0)) noreturn nounwind
  unreachable
                                                  ; No predecessors!
  br label %35
...
define void @_ZN23b2EdgeAndPolygonContact8EvaluateEP10b2ManifoldRK11b2TransformS4_(%class.b2EdgeAndPolygonContact* %this, %struct.b2Manifold* %manifold, %struct.b2Transform* %xfA, %struct.b2Transform* %xfB) align 2 {
  %1 = alloca %class.b2EdgeAndPolygonContact*, align 4
  ...
  %5 = load %class.b2EdgeAndPolygonContact** %1
  ...
  call void @_Z23b2CollideEdgeAndPolygonP10b2ManifoldPK11b2EdgeShapeRK11b2TransformPK14b2PolygonShapeS6_(%struct.b2Manifold* %6, %class.b2EdgeShape* %11, %struct.b2Transform* %12, %class.b2PolygonShape* %17, %struct.b2Transform* %18)
  ret void
}

declare void @_Z23b2CollideEdgeAndPolygonP10b2ManifoldPK11b2EdgeShapeRK11b2TransformPK14b2PolygonShapeS6_(%struct.b2Manifold*, %class.b2EdgeShape*, %struct.b2Transform*, %class.b2PolygonShape*, %struct.b2Transform*)
...
define linkonce_odr void @_ZN23b2EdgeAndPolygonContactD1Ev(%class.b2EdgeAndPolygonContact* %this) unnamed_addr align 2 {
  %1 = alloca %class.b2EdgeAndPolygonContact*, align 4
  store %class.b2EdgeAndPolygonContact* %this, %class.b2EdgeAndPolygonContact** %1, align 4
  %2 = load %class.b2EdgeAndPolygonContact** %1
  call void @_ZN23b2EdgeAndPolygonContactD2Ev(%class.b2EdgeAndPolygonContact* %2)
  ret void
}

define linkonce_odr void @_ZN23b2EdgeAndPolygonContactD0Ev(%class.b2EdgeAndPolygonContact* %this) unnamed_addr align 2 {
  %1 = alloca %class.b2EdgeAndPolygonContact*, align 4
  %2 = alloca i8*
  %3 = alloca i32
  store %class.b2EdgeAndPolygonContact* %this, %class.b2EdgeAndPolygonContact** %1, align 4
  %4 = load %class.b2EdgeAndPolygonContact** %1
  invoke void @_ZN23b2EdgeAndPolygonContactD1Ev(%class.b2EdgeAndPolygonContact* %4)
...
define linkonce_odr void @_ZN23b2EdgeAndPolygonContactD2Ev(%class.b2EdgeAndPolygonContact* %this) unnamed_addr align 2 {
  %1 = alloca %class.b2EdgeAndPolygonContact*, align 4
  store %class.b2EdgeAndPolygonContact* %this, %class.b2EdgeAndPolygonContact** %1, align 4
  %2 = load %class.b2EdgeAndPolygonContact** %1
